  ...
  return [
    {
      ...
      hint: "Use the New Project button in the Projects section.",
    ...
    {
      id: 4,
      label: "Create your first project theme",
      hint: "Open a project, then go to the Themes tab.",
    ...
    },
    {
      ...
      hint: "Open a project, then click Evidence Canvas.",
    ...
    },
    {
      ...
      hint: "Open a project, then click Generate Report.",
