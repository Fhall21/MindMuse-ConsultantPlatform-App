...
- Meeting ambiguity for quotes: if the user names a person or meeting that does not match lastMeetingId or multiple meetings exist — select_meeting_for_action only that turn with the correct pending_action (usually show_quotes), then wait for confirm.
